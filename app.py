...
try:
    from app_config import DevelopmentConfig, Config
    app_config = DevelopmentConfig
except ImportError:
    # Fallback to simple config
    from app_config import MYSQL_HOST, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DB, MYSQL_CURSORCLASS, SECRET_KEY, DEBUG
